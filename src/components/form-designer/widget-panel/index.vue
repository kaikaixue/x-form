<template>
  <el-scrollbar class="side-scroll-bar">
    <el-collapse class="widget-collapse" value="activeName">
      <el-collapse-item name="容器" title="容器">w1sdf11sdq1</el-collapse-item>
      ...
      <el-collapse-item name="高级字段" title="高级字段"></el-collapse-item>
      <el-collapse-item name="自定义字段" title="自定义字段"></el-collapse-item>
    </el-collapse>
  </el-scrollbar>
</template>
